...
search_terms = ["Machine Learning Engineer", "AI Developer", "Data Scientist", "Data Engineer", "ML Ops Developer", "AI Engineer", "AI Research Scientist", "AI Research Engineer", "AI Research Scientist", "AI Research Engineer", "Data Science Consultant", "Data Science Analyst", "Data Science Manager", "Data Science Lead"]
...
salary = "$90,000+"                        # "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"

easy_apply_only = True             # True or False, Note: True or False are case-sensitive

experience_level = ["Entry level", "Mid-Senior level", "Director", "Executive"]              # (multiple select) "Internship", "Entry level", "Associate", "Mid-Senior level", "Director", "Executive"
...
about_company_bad_words = ["University of Minnesota"]       # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
