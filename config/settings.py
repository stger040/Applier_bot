...
click_gap = 10                       # Enter max allowed secs to wait approximately. (Only Non Negative Integers Eg: 0,1,2,3,....)
...
# Chrome version pin: Set to your Chrome major version (e.g. 144) if you get "ChromeDriver only supports Chrome version X" errors.
# Check your version at chrome://settings/help. Set to None to auto-detect (may fail if Chrome hasn't updated yet).
chrome_version_main = 149          # e.g. 144, 145, or None
...
use_resume_generator = True       # True or False, Note: True or False are case-sensitive ,   This feature may only work with 'stealth_mode = True'. As ChatGPT website is hosted by CloudFlare which is protected by Anti-bot protections!
